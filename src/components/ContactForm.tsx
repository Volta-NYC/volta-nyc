...
const COPY: Record<Lang, {
  ...
  en: { businessName: "Business Name *", ownerName: "Your Name *", email: "Email *", neighborhood: "Neighborhood", services: "What do you need help with?", message: "Tell us more", messagePlaceholder: "What's your biggest challenge right now?", submit: "Send Message", submitting: "Sending…", successTitle: "Got it. We'll be in touch.", successBody: "We'll review your submission and reach out within a few days.", errorMsg: "Something went wrong. Email us at volta.newyork@gmail.com", footerNote: "We typically respond within 2–3 business days. Our services are 100% free.", dir: "ltr" },
  es: { businessName: "Nombre del negocio *", ownerName: "Su nombre *", email: "Correo electrónico *", neighborhood: "Vecindario", services: "¿Con qué necesita ayuda?", message: "Cuéntenos más", messagePlaceholder: "¿Cuál es su mayor desafío ahora mismo?", submit: "Enviar mensaje", submitting: "Enviando…", successTitle: "Recibido. Nos pondremos en contacto.", successBody: "Revisaremos su solicitud y le responderemos en pocos días.", errorMsg: "Algo salió mal. Escríbanos a volta.newyork@gmail.com", footerNote: "Generalmente respondemos en 2–3 días hábiles. Nuestros servicios son 100% gratuitos.", dir: "ltr" },
  zh: { businessName: "商户名称 *", ownerName: "您的姓名 *", email: "电子邮件 *", neighborhood: "所在社区", services: "您需要哪方面的帮助？", message: "请告诉我们更多", messagePlaceholder: "您目前面临的最大挑战是什么？", submit: "发送消息", submitting: "发送中…", successTitle: "已收到。我们会尽快联系您。", successBody: "我们将审核您的提交，并在几天内回复您。", errorMsg: "出现错误。请发送邮件至 volta.newyork@gmail.com", footerNote: "我们通常在 2–3 个工作日内回复。我们的服务完全免费。", dir: "ltr" },
  ko: { businessName: "사업체명 *", ownerName: "성함 *", email: "이메일 *", neighborhood: "동네", services: "어떤 도움이 필요하신가요?", message: "더 알려주세요", messagePlaceholder: "현재 가장 어려운 점은 무엇인가요?", submit: "메시지 보내기", submitting: "전송 중…", successTitle: "접수되었습니다. 곧 연락드리겠습니다.", successBody: "제출하신 내용을 검토하고 며칠 내에 연락드리겠습니다.", errorMsg: "오류가 발생했습니다. volta.newyork@gmail.com 으로 이메일 보내주세요.", footerNote: "보통 2–3 영업일 이내에 답변드립니다. 모든 서비스는 무료입니다.", dir: "ltr" },
  ar: { businessName: "اسم النشاط التجاري *", ownerName: "اسمك *", email: "البريد الإلكتروني *", neighborhood: "الحي", services: "ما الذي تحتاج إلى مساعدة فيه؟", message: "أخبرنا المزيد", messagePlaceholder: "ما هو أكبر تحديك الآن؟", submit: "إرسال الرسالة", submitting: "جارٍ الإرسال…", successTitle: "تم الاستلام. سنتواصل معك قريبًا.", successBody: "سنراجع طلبك ونتواصل معك خلال أيام قليلة.", errorMsg: "حدث خطأ ما. راسلنا على volta.newyork@gmail.com", footerNote: "نرد عادةً خلال 2–3 أيام عمل. خدماتنا مجانية 100%.", dir: "rtl" },
