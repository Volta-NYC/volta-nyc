        ...
        <div className="max-w-5xl mx-auto px-5 md:px-8">
          <AnimatedSection>
            ...
            <h1 className="font-display font-bold text-v-ink text-4xl md:text-5xl leading-tight mb-5">
              Practical playbooks for business owners.
            </h1>
            <p className="font-body text-v-muted text-lg max-w-3xl">
              We saw repeated confusion around vendor pricing, website costs, and what
              actually drives results. These guides are practical references business
              owners can use whether or not they work with us directly.
            </p>
          </AnimatedSection>
        </div>
      </section>
